                ...
                <section className=' bg-white h-full w-full sm:w-3/4 rounded-l-3xl'>
                    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                            ...
                            <h2 className="mt-10 text-center text-3xl font-semibold leading-9 tracking-tight text-black mb-7">Faça seu login</h2>
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            <form className="space-y-6" action="#" method='post' onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
                                ...
                                <div>
                                    <button type="submit" className="flex w-full justify-center rounded-full bg-[#005C6D] px-3 py-1.5 text-xl font-semibold leading-8 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 ">Entrar</button>
                                </div>
                            </form>
                        </div>
                    </div>
