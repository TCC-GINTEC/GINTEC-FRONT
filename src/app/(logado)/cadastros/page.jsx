            ...
            <div className="flex gap-4 py-2 flex-wrap">
                <Link href={"/jogos"}>
                    <div className="w-72 h-52 flex justify-center relative items-center p-6 gap-4 ">
                        <img src="/images/bgJogosPatios.png" className="absolute z-0 rounded-[40px] h-full w-full" />
                        <h2 className="z-10 text-white font-[500]">Jogos de Pátio</h2>
                    </div>
                </Link>
                <Link href={"/campeonatoQuadra"}>
                    <div className="w-72 h-52 flex justify-center relative items-center p-6 gap-4 ">
                        <img src="/images/bgCampeonatosQuadra.png" className="absolute z-0 rounded-[40px] h-full w-full" />
                        <h2 className="z-10 text-white font-[500]">Campeonatos <br />de quadra</h2>
                    </div>
                </Link>
                <Link href={"/campeonatoPatio"}>
                    <div className="w-72 h-52 flex justify-center relative items-center p-6 gap-4 ">
                        <img src="/images/bgCampeonatosPatio.svg" className="absolute z-0 rounded-[40px] h-full w-full" />
