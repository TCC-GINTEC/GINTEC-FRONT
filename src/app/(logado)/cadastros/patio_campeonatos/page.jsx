    ...
    <>
      ...
      {showForm && (
        <>
          ...
          <ContainerCampeonatoQuadra alert={'Caso deseje editar algo, aperte do campo desejado e edite'} classe={'-mt-40 sm:m-auto fixed inset-0 bg-white flex items-center justify-center z-50 p-4'}>
